...
const CACHE_NAME = 'lifeos-staging-v5.33';
const APP_SHELL = [
  '/CoworkKanban/staging/',
  '/CoworkKanban/staging/index.html',
  '/CoworkKanban/staging/style.css',
  '/CoworkKanban/staging/manifest.json',
  '/CoworkKanban/staging/icon-192.png',
  '/CoworkKanban/staging/icon-512.png'
];
...
self.addEventListener('fetch', event => {
  ...
  if (url.pathname.startsWith('/CoworkKanban/staging/')) {
    event.respondWith(
