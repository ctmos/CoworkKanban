...
const VALID_LANES = ['JZ','HE','HD','HB','BA','WB','IK','PA','FI','FA','FR','PR','EV','EM','EX','MA','TB','EK'];
...
async function loadFromGitHub() {
  ...
  try {
    ...
    // Load patients (with decryption support)
...
function renderPatients(filter) {
  ...
  function renderPatRow(p) {
    ...
    if (p.aufnahme) {
      ...
      if (diffDays >= 0) { var w = Math.floor(diffDays / 7); var d = diffDays % 7; dauerBadge = '<span class="pat-dauer-badge">' + w + 'W ' + d + 'T</span>'; }
    }
